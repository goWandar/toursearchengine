    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          nudge:
            'Educational safaris feature expert guides, village visits, and conservation talks.',
        },
        {
          value: 'wildlife',
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          nudge:
            'You can plan around perfect weather, wildlife migrations, and best-value periods.',
        },
      ],
    },
    {
      ...
      options: [
        {
          ...
          nudge:
            "Ideal for privacy and tranquility — we'll recommend hidden gems and smaller camps.",
        },
        {
          value: 'dontmind',
