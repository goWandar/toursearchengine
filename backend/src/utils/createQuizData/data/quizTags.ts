...
export const tags: Tag[] = [
  ...
  { key: 'budget:economy', label: 'Economy', category: 'budget' },
  { key: 'budget:standard', label: 'Standard', category: 'budget' },
  { key: 'budget:midrange', label: 'Midrange', category: 'budget' },
  { key: 'budget:premium', label: 'Premium', category: 'budget' },
  ...
  { key: 'accommodation:mobile-camp', label: 'Mobile Camp', category: 'accommodation' },
  { key: 'accommodation:lodge', label: 'Lodge', category: 'accommodation' },
  { key: 'accommodation:villa', label: 'Private Villa', category: 'accommodation' },
  ...
  { key: 'activity:walking-safari', label: 'Walking Safari', category: 'activity' },
  { key: 'activity:cultural-visit', label: 'Cultural Visits', category: 'activity' },
  { key: 'activity:photography-tour', label: 'Photography Tour', category: 'activity' },
