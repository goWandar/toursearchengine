      ...
      <Alert {...args} className="flex items-start justify-between gap-3">
        <div className="flex items-start gap-3 flex-1">
          ...
          <div>
            ...
            <AlertDescription>
              We&aposve added dark mode support to your dashboard. Try it out in your settings.
            </AlertDescription>
          </div>
        </div>
        <Button size="icon" variant="ghost" className="flex-shrink-0" aria-label="Close alert">
          <X className="h-4 w-4" />
        </Button>
      </Alert>
    </div>
        ...
        <div className="flex items-start gap-3 flex-1">
          ...
          <div>
            ...
            <AlertDescription className="mb-3">
              Your document has been uploaded and is now being processed. You&apos;ll receive a
