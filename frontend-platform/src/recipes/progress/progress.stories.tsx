...
const meta: Meta<typeof Progress> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'A progress indicator that shows the completion progress of a task, typically displayed as a progress bar.',
      },
    },
  },
  tags: ['autodocs'],
  ...
  render: () => {
    ...
    return (
      <div className="space-y-4 w-80">
        ...
        <Button onClick={() => setProgress(Math.floor(Math.random() * 100))} size="sm">
          Randomize Progress
        </Button>
      </div>
    );
    ...
    return (
      <Card className="w-96">
        <CardHeader>
          ...
          <CardDescription>Upload your files with progress tracking</CardDescription>
        </CardHeader>
  ...
  render: () => (
    <div className="space-y-6 w-80">
      <div className="space-y-2">
        ...
        <Progress value={60} className="h-3 bg-red-100 [&>div]:bg-red-500" />
        <Progress value={80} className="h-3 bg-green-100 [&>div]:bg-green-500" />
